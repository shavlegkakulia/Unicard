...
public class TransactionsPresenter extends BasePresenterImpl<TransactionsContract.View>
        implements TransactionsContract.Presenter {
    ...
    @Inject
    public TransactionsPresenter(PrintReportInteractorImpl printerInteractor,
    ...
    @Override
    public void onSubmitPrinterReport() {
