 ...
 */
public class BonusAccumulationFragment
        extends CardsFragment{

    public static BonusAccumulationFragment newInstance() {
        return new BonusAccumulationFragment();
    }

    @Inject
    BonusAccumulationPresenterImpl presenter;
    ...
    protected String getActionLabel() {
        return getString(R.string.action_bonus_accumulation);
    }
